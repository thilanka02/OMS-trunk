package com.ico.service.impl;

import org.apache.commons.lang.StringUtils;
import com.ico.dao.UserDao;
import com.ico.model.User;
import com.ico.service.MailEngine;
import com.ico.service.UserExistsException;
import com.ico.service.UserManager;
import com.ico.service.UserService;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "com.ico.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see com.ico.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
