...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.ico.service.impl.PasswordTokenManager#generateRecoveryToken(com.ico.model.User)
     */
    @Override
    ...
    /**
     * @see com.ico.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.ico.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.ico.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
